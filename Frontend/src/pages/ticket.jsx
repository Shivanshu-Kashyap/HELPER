    ...
    return (
      <div className="min-h-screen bg-black flex items-center justify-center">
        <div className="flex flex-col items-center space-y-4">
          ...
          <div className="text-zinc-400 text-lg">Loading ticket details...</div>
        </div>
      </div>
    )
  }
    ...
    return (
      <div className="min-h-screen bg-black flex items-center justify-center">
        <div className="text-center">
          ...
          <Link to="/tickets" className="text-orange-400 hover:text-orange-300">Return to Tickets</Link>
        </div>
      </div>
    )
  }
  ...
  return (
    <div className="min-h-screen bg-black py-12 px-4 sm:px-6 lg:px-8 relative overflow-hidden">
      ...
      <div className="absolute inset-0 z-0 pointer-events-none">
        ...
        <div className="absolute bottom-0 right-0 w-[50%] h-[50%] bg-orange-500/5 rounded-full blur-[120px]"></div>
      </div>

      <div className="max-w-5xl mx-auto relative z-10">
        <Link to="/tickets" className="inline-flex items-center text-zinc-400 hover:text-white mb-8 transition-colors group">
        ...
        <div className="grid grid-cols-1 lg:grid-cols-3 gap-8">
          ...
          <div className="lg:col-span-2 space-y-8">
            ...
            <div className="bg-zinc-900/40 backdrop-blur-xl rounded-3xl p-8 border border-white/5 shadow-xl">
              ...
              <div className="prose prose-invert max-w-none">
                <p className="text-zinc-300 text-lg leading-relaxed">{ticket.description}</p>
              </div>

              <div className="flex items-center space-x-6 mt-8 pt-6 border-t border-white/5 text-sm text-zinc-400">
            ...
            {/* AI Analysis Card */}
            {ticket.helpfulNotes && (
              <div className="bg-gradient-to-br from-orange-900/10 to-amber-900/10 backdrop-blur-xl rounded-3xl p-8 border border-orange-500/20 shadow-xl relative overflow-hidden">
                ...
                <div className="prose prose-invert max-w-none text-zinc-300 bg-black/20 rounded-xl p-6 border border-white/5">
                ...
                {canEdit ? (
                  <div className="space-y-6">
                    <div className="space-y-2">
                      <label className="block text-sm font-medium text-zinc-300">Solution Details</label>
                      <textarea
                        value={solution}
                    ...
                    <div className="flex flex-col sm:flex-row gap-4 items-center justify-between bg-zinc-800/30 p-4 rounded-xl border border-white/5">
                      <div className="w-full sm:w-auto">
                        <label className="block text-xs font-medium text-zinc-400 mb-1">Status</label>
                        <select
                          value={status}
                          onChange={(e) => setStatus(e.target.value)}
                          className="w-full sm:w-48 bg-zinc-900 border border-zinc-700 rounded-lg px-3 py-2 text-white focus:border-orange-500 focus:outline-none"
                        >
                      ...
                      <button
                        ...
                        disabled={updating}
                        className="w-full sm:w-auto px-6 py-2.5 bg-orange-500 text-white rounded-lg font-semibold shadow-lg hover:bg-orange-600 transition-all duration-300 disabled:opacity-50 disabled:cursor-not-allowed"
                      >
                  ...
                  <div className="text-center py-8 text-zinc-500 bg-zinc-800/30 rounded-xl border border-white/5 border-dashed">
          ...
          <div className="space-y-6">
            ...
            <div className="bg-zinc-900/40 backdrop-blur-xl rounded-3xl p-6 border border-white/5 shadow-xl">
              ...
              <div className="flex items-center space-x-3 p-3 bg-zinc-800/50 rounded-xl border border-white/5">
              ...
              <div className="bg-zinc-900/40 backdrop-blur-xl rounded-3xl p-6 border border-white/5 shadow-xl">
                ...
                <div className="flex flex-wrap gap-2">
                  {ticket.relatedSkills.map((skill, index) => (
                    <span
                      key={index}
                      className="px-3 py-1.5 bg-zinc-800 text-zinc-300 rounded-lg text-sm border border-zinc-700 hover:border-orange-500/50 hover:text-orange-400 transition-colors cursor-default"
                    >
                      {skill}
                    </span>
                  ))}
